...
const Header = () => {
  ...
  return <header className="py-4 px-4 sm:px-6 lg:px-8 w-full border-b sticky top-0 bg-white z-50">
      <div className="container mx-auto flex items-center justify-between">
        <div className="flex items-center">
          <img src="/lovable-uploads/c1fa3a5b-2ee1-47c2-a887-35cc50f1f63f.png" alt="ResumeHatch Logo" className="h-12 mr-2" />
        ...
        <div className="flex items-center">
          <Button className="bg-brand-blue hover:bg-blue-700 text-white" onClick={() => setIsWaitlistOpen(true)}>
            Join the Waitlist
          </Button>
        </div>
      </div>
