...
const FaqSection = () => {
  ...
  return <section id="faq" className="py-20 px-4 bg-gray-50 md:py-[80px]">
      <div className="container mx-auto max-w-3xl">
        ...
        <div className="space-y-4">
          {faqs.map((faq, index) => <div key={index} className="bg-white rounded-xl overflow-hidden shadow-sm border border-gray-100">
              <button onClick={() => toggleAccordion(index)} className="flex justify-between items-center w-full p-6 text-left">
                <span className="text-lg font-medium">{faq.question}</span>
                <span className="text-brand-blue">
                  {activeIndex === index ? <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
              ...
              {activeIndex === index && <div className="px-6 pb-6">
